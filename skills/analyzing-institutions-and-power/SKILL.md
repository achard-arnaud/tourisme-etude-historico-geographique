---
name: analyzing-institutions-and-power
description: Use when an arc requires analysis of regimes, succession, administration, law, coalitions, legitimacy, state capacity, access to public institutions, or institutional continuity and rupture.
---
...
## Output
HIL-01 analytic notes (access architecture, policy instrument matrix) that become `templates/claim.md` records under `02_hil/HIL-01_institutions-chronology/Z<n>/`, ready for `building-causal-bridges` and `structuring-chronological-arcs`.
