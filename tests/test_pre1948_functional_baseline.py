...
STATEMENT_TYPES = {
    ...
    "counterfactual", "metric", "policy_intent", "policy_effect", "question",
    "discarded_lead",
}
...
class Pre1948FunctionalBaselineTests(unittest.TestCase):
    ...
    def test_questions_and_workflow_baseline_are_persisted(self):
        backlog = PROJECT / "08_questions" / "baseline_questions.md"
        self.assertTrue(backlog.exists())
        manifest = json.loads((REPO / "docs" / "RUN9_PRE1948_FUNCTIONAL_BASELINE.json").read_text(encoding="utf-8"))
