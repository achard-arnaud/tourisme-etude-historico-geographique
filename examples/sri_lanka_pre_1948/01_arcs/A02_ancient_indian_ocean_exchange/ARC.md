# A02 — Ancient Indian Ocean exchange

- evidence_status: researched
- Entry rupture: the island becomes archaeologically visible as a node in overlapping South Asian and Indian Ocean exchange systems.
- Zooms: Z0 artefact → Z1 site/port → Z2 inland polity → Z3 Indian Ocean network → Z4 interregional system → return local.
- Primary HILs: economy/infrastructure; geography/environment; regional-global system.

## Causal problem

**How can an inland hydraulic capital participate deeply in Indian Ocean exchange without depending on a single port or requiring direct royal control of every maritime transaction?**

## Causal spine

The strongest evidence no longer supports a mental map in which Anuradhapura is an isolated inland capital that occasionally trades through one maritime outlet. Water storage, agrarian concentration, monasteries and political institutions created an interior zone capable of sustaining population, redistribution and long-distance demand. That interior was connected over time to **several coastal facades whose functions and importance changed by period**.

Mantai/Mahātittha on the north-western coast remains the strongest long-duration entrepôt in the present archaeological record. Its position near Mannar and Palk linked the Anuradhapura interior to South India and to longer western/eastern Indian Ocean circuits. The Run36 hydraulic-to-Mantai bridge therefore remains valid, but Run48 broadens it: Mantai was a major gateway, not the whole maritime system.
...
**water-managed inland concentration → redistribution corridors → changing northern/north-western, eastern and southern gateways → maritime exchange, diplomacy and religious circulation.**

This is a network proposition, not a claim of a centrally planned four-port state.
...
- Do not write “four cardinal ports”: the actual distribution is north/north-west, east and south.
...
Once the inland polity is understood as part of a changing multi-port network, the narrative can widen to the monsoon system itself: seasonal winds, resident merchant communities, regional political cycles and maritime traditions alter which ports are valuable and which external connections are available. This passes the reader into A03 without inflating route evidence into direct-contact claims.
