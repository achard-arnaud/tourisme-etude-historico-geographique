...
def build(key:str)->dict:
    ...
    reader=(project/"09_output"/spec["markdown_output"]).read_text(encoding="utf-8");required=assert_rendered_arc_recaps(project,reader)
    ...
    metric["arc_recaps"]=recap_count;metric["side_stories_materialized"]=story_inserted;return metric
def main():
